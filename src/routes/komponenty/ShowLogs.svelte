...
<div class="p-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex justify-center items-center">
                                <button
                                    class="px-4 py-2 bg-blue-500 text-white rounded comment-button ml-2"
    ...
    {#if $showModal}
        ...
        >
            <div
                class="bg-white my-20 mx-auto p-5 border border-gray-400 w-full max-w-4xl rounded-lg"
            >
                    ...
                    <div class="w-1/2">
                        ...
                        <form
                            ...
                            use:enhance={({ formData }) => {
                                ...
                                formData.append(
                                    "wejscie",
                                    $currentLog.entrence_time,
                                );
                            }}
                        >
                            <input
                                type="text"
                                class="w-full px-4 py-2 border rounded mr-2 flex-1 mb-4"
                        ...
                        {#if $modalHistory}
                            <table
                                class="w-full border-collapse mt-4 text-center"
                            >
                                <thead>
                                    <tr>
                                        <th>Data</th>
                            ...
                            <div class="mb-4">
                                ...
                                <form
                                    ...
                                    use:enhance={({ formData }) => {
                                        ...
                                        formData.append(
                                            "wyjscie",
                                            $currentLog.exit_time,
                                        );
                                    }}
                                >
                                    <input
                                        type="text"
                                        class="w-full px-4 py-2 border rounded mr-2 flex-1 mb-2"
                                        placeholder="Edytuj godzinę"
                                        name="entrance_time"
                            ...
                            <div>
                                ...
                                >
                                    <input
                                        type="text"
                                        class="w-full px-4 py-2 border rounded mr-2 flex-1 mb-2"
                                        placeholder="Edytuj godziny"
                                        name="hours"
                                        bind:value={$currentLog.hours}
                                    />
                                    <button
                                        class="w-full px-4 py-2 bg-blue-500 text-white rounded"
                                        type="submit">Zapisz</button
    ...
    {#if $showReportModal}
        ...
        >
            <div
                class="bg-white my-20 mx-auto p-5 border border-gray-400 w-72 rounded-lg"
            >
                ...
                <h2 class="mt-0">
                    <strong
                        >Pobierz Raport użytkownika&nbsp;
                    </strong>{selectedUser.imie}
                    {selectedUser.nazwisko}
                </h2>
                <div class="mt-2">
