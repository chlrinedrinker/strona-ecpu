<script lang="ts">
  ...
  import NavbarKalendarz from './NavbarKalendarz.svelte'; // Import Navbar
  ...
  export let pracownicy: Pracownik[] = [];
  export let selectedUser: Pracownik | null = null;
  export let logowania: { _id: string; date: string; entrence_time: string; exit_time: string; hours: number }[] = [];
